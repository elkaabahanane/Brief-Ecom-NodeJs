...
var dbConn  = require('../utils/connection.js');
...
router.post('/add', function(req, res, next) {    
    ...
    if(!errors) {
        ...
        // insert query
        dbConn.query('INSERT INTO category SET ?', form_data, function(err, result) {
            //if(err) throw err
            if (err) {
                req.flash('error', err)
...
router.get('/edit/(:id)', function(req, res, next) {
    ...
    dbConn.query('SELECT * FROM category WHERE id = ' + id, function(err, rows, fields) {
        if(err) throw err
